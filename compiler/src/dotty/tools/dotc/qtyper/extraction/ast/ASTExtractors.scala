package dotty.tools.dotc.qtyper.extraction.ast
...
//  protected lazy val nilSymbol  = classFromName("stainless.collection.Nil")
  ...
  private val unsupportedSymMsg =
    new reporting.diagnostic.NoExplanation("Symbol/Type currently unsupported (stainless-library dependency)")
  private def errorSym(name: String) = ctx.newErrorSymbol(NoSymbol, core.Names.typeName(name), unsupportedSymMsg)
  protected lazy val setSym = errorSym("Set")
  protected lazy val mapSym = errorSym("Map")
  protected lazy val bagSym = errorSym("Bag")
  protected lazy val realSym = errorSym("Real")
  protected lazy val optionSymbol = errorSym("Option")
  protected lazy val someSymbol   = errorSym("Some")
  protected lazy val noneSymbol   = errorSym("None")
  protected lazy val listSymbol   = errorSym("List")
  protected lazy val consSymbol   = errorSym("Cons")
  protected lazy val nilSymbol    = errorSym("Nil")
